  ...
  return (
    <div className={cn("relative", className)}>
      <button
        ...
        onClick={() => setIsVideoOpen(true)}
      >
        {/* ✅ next/image instead of <img> — fixes no-img-element warning */}
        <div className="relative w-full aspect-video rounded-md border shadow-lg overflow-hidden transition-all duration-200 ease-out group-hover:brightness-[0.8]">
          <Image
            src={thumbnailSrc}
            alt={thumbnailAlt}
            fill
          ...
          >
            ...
            >
              <button
                ...
                onClick={() => setIsVideoOpen(false)}
                className="absolute -top-16 right-0 rounded-full bg-neutral-900/50 p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black transition-opacity hover:opacity-80"
              >
                <XIcon className="size-5" />
              </button>
              <div className="relative isolate z-[1] size-full overflow-hidden rounded-2xl border-2 border-white">
