...
//     console.log("📥 Received advisory payload:");
...
//     // 🔎 Validate nested recommendation structure
//     if (!body.recommendations.fertilizers || !Array.isArray(body.recommendations.fertilizers)) {
//       return NextResponse.json(
//         { error: "Invalid fertilizers format. Expected an array." },
//         { status: 400 }
//       );
//     }

//     if (!body.recommendations.pest_control || !Array.isArray(body.recommendations.pest_control)) {
//       return NextResponse.json(
//         { error: "Invalid pest_control format. Expected an array." },
//         { status: 400 }
//       );
//     }

//     // 💾 Save advisory to Convex
//     const savedId = await client.mutation(api.addAgriAdvisory, body);

//     console.log("✅ Advisory saved successfully:", savedId);
...
//     });
//   } catch (error: any) {
//     console.error("❌ Error saving advisory:", error?.response ?? error);

//     return NextResponse.json(
//       {
//         error: error?.message || "Failed to save advisory",
//       },
//       { status: 500 }
//     );
//   }
